            ...
            {status === 'pending' && (
              <>
                <Tooltip title="Identify">
                  <IconButton
                    onClick={() => onAction(MATCH_INFO_CARD_ACTIONS.ACTION_IDENTIFY)}
                    size="large">
                ...
                <Tooltip title="Mark as original">
                  <IconButton
                    onClick={() => onAction(MATCH_INFO_CARD_ACTIONS.ACTION_IGNORE)}
                    size="large">
            ...
            {status === 'ignored' && (
              <>
                <Tooltip title="Restore">
                  <IconButton
                    onClick={() => onAction(MATCH_INFO_CARD_ACTIONS.ACTION_RESTORE)}
                    size="large">
            ...
            {status === 'identified' && (
              <>
                <Tooltip title="Remove identification">
                  <IconButton
                    onClick={() => onAction(MATCH_INFO_CARD_ACTIONS.ACTION_DETACH)}
                    size="large">
                    <RestoreOutlined className="icon" />
                  </IconButton>
                </Tooltip>
                <Tooltip title="View identification">
                  <IconButton
                    onClick={() => onAction(MATCH_INFO_CARD_ACTIONS.ACTION_DETAIL)}
                    size="large">
                    <DescriptionOutlined />
                  </IconButton>
                </Tooltip>
