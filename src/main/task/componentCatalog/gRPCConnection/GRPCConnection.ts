...
class GRPCConnection {
  ...
  public get(): ComponentsClient {
    ...
    const apiKey = workspace.getOpenProject().getApi() || APIS[DEFAULT_API_INDEX]?.API_KEY;
    ...
    if ((this.client == null) || (this.apiKey !== apiKey)) {
      ...
      this.client = new ComponentsClient(`${AppConfigDefault.DEFAULT_IP_gRPC}:${AppConfigDefault.DEFAULT_PORT_gRPC}`, combCreds);
    }
