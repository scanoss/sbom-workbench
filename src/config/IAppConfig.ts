...
export interface IAppConfig {
  ...
  DEFAULT_DEPENDENCY_SERVICE_CHUNK_LIMIT: number;
  DEFAULT_CRYPTOGRAPHY_SERVICE_CHUNK_LIMIT: number;
  DEFAULT_VULNERABILITY_SERVICE_CHUCK_LIMIT: number;
  ...
  SCANOSS_CRYPTO_ALGORITHM_RULES_FILENAME: string;
  SCANOSS_CRYPTO_LIBRARY_RULES_FILE_NAME: string;
}
