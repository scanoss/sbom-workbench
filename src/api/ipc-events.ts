...
export const ipcRendererEvents = [
  ...
  IpcEvents.COMPONENT_GET_ALL,
  IpcEvents.COMPONENT_GET_GLOBAL_COMPONENTS,
  IpcEvents.COMPONENT_GET_GLOBAL_COMPONENT_VERSION,
  ...
  IpcEvents.DIALOG_BUILD_CUSTOM_POPUP_MENU,

  IpcEvents.CONTEXT_MENU_COMMAND,

  IpcEvents.SEARCH_ENGINE_START_INDEXING,
  IpcEvents.SEARCH_ENGINE_SEARCH_RESPONSE,

  IpcEvents.MIGRATION_INIT,
  IpcEvents.MIGRATION_FINISH,
];
